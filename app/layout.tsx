...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <header className="fixed w-full top-0 z-50 bg-gradient-to-r from-gray-900 to-black p-4 shadow-md">
            ...
            <div>
              <a href="#" aria-label="GitHub repository">
                <svg
                  ...
                  width="24"
                  height="24"
                  className="fill-white hover:fill-purple-400 transition-colors"
                >
